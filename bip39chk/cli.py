...
from bip39chk.chain.fees import estimate_fee
from bip39chk.config import WalletConfig
from bip39chk.services.sync import SyncEngine
...
def portfolio() -> None:
    ...
    click.echo(f"coin=BIP39 total={total} fee_hint={fee}")
